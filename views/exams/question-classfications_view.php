...
<script type="text/javascript">
 ...
 olexam_category.app = function()
 {
 		...
 		getGrid: function()
 		{
 			...
 			var Objstore = new Ext.data.Store({
 						proxy: new Ext.data.HttpProxy({
 							url: "<?php echo site_url('questionclassifications/getQuestionClassifications') ?>",
 							method: "POST"
 							}),
    ...
    var colModel = new Ext.grid.ColumnModel([
        {header: "Id", width: 75, sortable: true, dataIndex: 'QUCLIDNO'},
        {header: "Description", width: 150, sortable: true, dataIndex: 'description'}
 		    ...
 		    var form = new Ext.form.FormPanel({
 		        labelWidth: 150,
 		        url: "<?php echo site_url('questionclassifications/addQuestionClassification') ?>",
 		        method: 'POST',
 		...
 		Edit: function(){
 			...
 			var id = sm.getSelected().data.QUCLIDNO;
 		    ...
 		    _window = new Ext.Window({
 		        ...
 		        buttons: [{
 		            ...
 		            handler: function () {
 			            if(ExtCommon.util.validateFormFields(olexam_category.app.Form)){//check if all forms are filled up
 		                olexam_category.app.Form.getForm().submit({
 			                url: "<?php echo site_url('questionclassifications/updateQuestionClassification') ?>",
 			                params: {id: id},
 			                method: 'POST',
 			                success: function(f,action){
                 		    	Ext.MessageBox.alert('Status', action.result.data);
 		  	...
 		  	olexam_category.app.Form.getForm().load({
 				url: "<?php echo site_url('questionclassifications/loadQuestionClassification') ?>",
 				method: 'POST',
 				params: {id: id},
 				timeout: 300000,
 				waitMsg:'Loading...',
		...
		Delete: function(){
			...
			Ext.Msg.show({
  			...
  			msg: 'Are you sure you want to delete this record?',
   			...
   			Ext.Ajax.request({
                            url: "<?php echo site_url('questionclassifications/deleteQuestionClassification') ?>",
							params:{ id: id},
							method: "POST",
							timeout:300000000,
